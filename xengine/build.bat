...
set Defines= -DPLATFORM_WINDOWS=1 -nologo -DCRT_SECURE_NO_WARNINGS

set PreprocessorLibs= kernel32.lib user32.lib gdi32.lib winmm.lib
...
cl %Defines% -Zi -EHsc -Od ../src/xengine/preprocessor.cpp /link %PreprocessorLibs% %CommonLinkerFlags% /out:preproc.exe
