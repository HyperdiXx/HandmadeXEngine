...
set CommonCompilerFlags= -Zi -Od /EHsc /I ../src/ /I ../src/xengine/external/freetype/
set CommonLinkerFlags= -incremental:no -opt:ref /Debug:fastlink
set PlatformLibs= opengl32.lib kernel32.lib user32.lib gdi32.lib winmm.lib ../src/xengine/libs/freetype.lib
...
cl %Defines% -nologo /Zi /FC /EHsc /I ../src/ /I ../src/xengine/external/ ../src/game/application.cpp /LD /link %GameLibs% -opt:ref -incremental:no /Debug:fastlink /out:application.dll
popd