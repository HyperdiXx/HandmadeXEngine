...
set PlatformLibs= opengl32.lib kernel32.lib user32.lib gdi32.lib winmm.lib
...
cl %Defines% -nologo /Zi /FC /EHsc /I ../src/ ../src/game/application.cpp /LD /link %GameLibs% -opt:ref -incremental:no /Debug:fastlink /out:application.dll
popd