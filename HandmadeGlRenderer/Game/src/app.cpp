...
namespace XEngine
{
    ...
    void Application::OpenGLRunEngineWin32()
    {
        ...
        VAO::createVertexBuffer(&plane, planeVertices);
        ...
        while (!glfwWindowShouldClose(wb.window))
        {
            ...
            WINInput::processInput(wb.window, &cam);
        ...
        VAO::delGeometry(&plane);
        VAO::delGeometry(sky.getGeometryBuffer());
    ...
    void Application::RenderQ(Shader *shader)
    {
